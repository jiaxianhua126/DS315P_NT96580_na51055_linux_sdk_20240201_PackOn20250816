...
#if LV_COLOR_DEPTH == 8
	#define LV_COLOR_TRANSP    LV_COLOR_MAKE(0,0,0)         
#else
	#define LV_COLOR_TRANSP    LV_COLOR_MAKE(0x55,0x1f,0x57)         
#endif
...
#define LV_USE_GPU_NVT_DMA2D    1   /*use gfx engine when double buffer copy */
...
#if LV_TICK_CUSTOM == 1
#define LV_TICK_CUSTOM_INCLUDE  <kwrap/perf.h>       /*Header for the sys time function*/
