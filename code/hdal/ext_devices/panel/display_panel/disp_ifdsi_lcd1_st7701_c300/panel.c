...
#define DSI_TARGET_CLK             240  //FPGA use 160MHz
...
#define _IDE_FDCLK      60000000

extern struct miscdevice lcdmirrorflip_miscdev;
...
*/
{DSICMD_CMD,0x36},//Write(Command , 0x36); 
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);  
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);  

{DSICMD_CMD,0x3A},//Write(Command , 0x3A);     
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);       
{DSICMD_DATA,0x05},//Write(Parameter , 0x05);  

{DSICMD_CMD,0xB0},//Write(Command , 0xB0); //MIPI Video Mode
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);   
{DSICMD_DATA,0x10},//Write(Parameter , 0x10);

{DSICMD_CMD,0xB2},//Write(Command , 0xB2);     
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);      
{DSICMD_DATA,0x1F},//Write(Parameter , 0x1F);   
{DSICMD_DATA,0x00},//(Parameter , 0x00);    
{DSICMD_DATA,0x1F},//Write(Parameter , 0x1F);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);    
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);  
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);   
{DSICMD_DATA,0x33},//Write(Parameter , 0x33);   
{DSICMD_DATA,0x00},//(Parameter , 0x00);   
{DSICMD_DATA,0x33},//(Parameter , 0x33); 

{DSICMD_CMD,0xB7},//Write(Command , 0xB7);  
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);     
{DSICMD_DATA,0x50},//Write(Parameter , 0x50);   

{DSICMD_CMD,0xBB},//Write(Command , 0xBB);     
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);      
{DSICMD_DATA,0x23},//Write(Parameter , 0x23);   

{DSICMD_CMD,0xC0},//Write(Command , 0xC0);     
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);    
{DSICMD_DATA,0x2C},//Write(Parameter , 0x2C);   

{DSICMD_CMD,0xC2},//Write(Command , 0xC2);     
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);       
{DSICMD_DATA,0x01},//Write(Parameter , 0x01);   

{DSICMD_CMD,0xC3},//Write(Command , 0xC3);  
{DSICMD_DATA,0x00},//Write(Parameter , 0x00); 
{DSICMD_DATA,0x15},//Write(Parameter , 0x15);   

{DSICMD_CMD,0xC4},//Write(Command , 0xC4);     
{DSICMD_DATA,0x20},//Write(Parameter , 0x20);   //VDV, 0x20:0v

{DSICMD_CMD,0xC6},//Write(Command , 0xC6);
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);      
{DSICMD_DATA,0xFE},//Write(Parameter , 0xFE);   

{DSICMD_CMD,0xD0},//Write(Command , 0xD0); 
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);      
{DSICMD_DATA,0xA7},//Write(Parameter , 0xA7); 

{DSICMD_CMD,0xD0},//Write(Command , 0xD0); 
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);      
{DSICMD_DATA,0xA4},//Write(Parameter , 0xA4);
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);     
{DSICMD_DATA,0xA1},//Write(Parameter , 0xA1);   

{DSICMD_CMD,0xD6},//Write(Command , 0xD6);     
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);     
{DSICMD_DATA,0xA1},//Write(Parameter , 0xA1);   //sleep in后，gate输出为GND

{DSICMD_CMD,0xE0},//Write(Command , 0xE0);  
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);   
{DSICMD_DATA,0x00},//Write(Parameter , 0xF0); 
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);  
{DSICMD_DATA,0x0E},//Write(Parameter , 0x0E);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x15},//Write(Parameter , 0x15);  
{DSICMD_DATA,0x00},//Write(Parameter , 0x00); 
{DSICMD_DATA,0x09},//Write(Parameter , 0x09);  
{DSICMD_DATA,0x00},//Write(Parameter , 0x00); 
{DSICMD_DATA,0x09},//Write(Parameter , 0x09);  
{DSICMD_DATA,0x00},//Write(Parameter , 0x00); 
{DSICMD_DATA,0x06},//Write(Parameter , 0x06); 
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);  
{DSICMD_DATA,0x37},//Write(Parameter , 0x37);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x43},//Write(Parameter , 0x43);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x4B},//Write(Parameter , 0x4B);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x38},//Write(Parameter , 0x38);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x14},//Write(Parameter , 0x14);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x12},//Write(Parameter , 0x12);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x2C},//Write(Parameter , 0x2C);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x33},//Write(Parameter , 0x33);   

{DSICMD_CMD,0xE1},//Write(Command , 0xE1);     
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0xF0},//Write(Parameter , 0xF0);  
{DSICMD_DATA,0x00},//Write(Parameter , 0x00); 
{DSICMD_DATA,0x11},//Write(Parameter , 0x11); 
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);  
{DSICMD_DATA,0x16},//Write(Parameter , 0x16); 
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);  
{DSICMD_DATA,0x0B},//Write(Parameter , 0x0B);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x0A},//Write(Parameter , 0x0A); 
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);  
{DSICMD_DATA,0x24},//Write(Parameter , 0x24);  
{DSICMD_DATA,0x00},//Write(Parameter , 0x00); 
{DSICMD_DATA,0x37},//Write(Parameter , 0x37); 
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);  
{DSICMD_DATA,0x32},//Write(Parameter , 0x32);  
{DSICMD_DATA,0x00},//Write(Parameter , 0x00); 
{DSICMD_DATA,0x4B},//Write(Parameter , 0x4B);  
{DSICMD_DATA,0x00},//Write(Parameter , 0x00); 
{DSICMD_DATA,0x35},//Write(Parameter , 0x35); 
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);  
{DSICMD_DATA,0x12},//Write(Parameter , 0x12); 
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);  
{DSICMD_DATA,0x14},//Write(Parameter , 0x14);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x2E},//Write(Parameter , 0x2E);  
{DSICMD_DATA,0x00},//Write(Parameter , 0x00); 
{DSICMD_DATA,0x34},//Write(Parameter , 0x34);   

{DSICMD_CMD,0xE4},//Write(Command , 0xE4);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);  
{DSICMD_DATA,0x1D},//Write(Parameter , 0x1D);   //使用240根gate  (N+1)*8
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);   //设定gate起点位置
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);   //当gate没有用完时，bit4(TMG)设为0

{DSICMD_CMD,0x35},//Write(Command , 0x35);    
{DSICMD_DATA,0x00},//Write(Parameter , 0x00); 
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);   


{DSICMD_CMD,0x21},//Write(Command , 0x21);     

{DSICMD_CMD,0x29},//Write(Command , 0x29);     

{DSICMD_CMD,0x2A},//Write(Command , 0x2A);     //Column Address Set
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);   //0
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0xEF},//Write(Parameter , 0xEF);   //239

{DSICMD_CMD,0x2B},//Write(Command , 0x2B);     //Row Address Set
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);   
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);
{DSICMD_DATA,0x00},//Write(Parameter , 0x00);   //0
...
{DSICMD_CMD,0x2C},//Write(Command , 0x2C);     
...
static int __init panel_init(void)
{
    ...
    misc_register(&lcdmirrorflip_miscdev);
