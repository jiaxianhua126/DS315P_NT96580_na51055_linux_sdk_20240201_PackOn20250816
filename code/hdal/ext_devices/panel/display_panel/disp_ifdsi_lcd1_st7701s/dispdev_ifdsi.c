...
#define DISPDEV_IFDSI_TYPE     DISPDEV_IFDSI_ST7701S
#else
#define DISPDEV_IFDSI_TYPE     DISPDEV_IFDSI_ST7701S
#endif
#endif
...
static ER dsi_lp_write_cmd(DSI_LANESEL ui_data_lane, UINT32 ui_dsc_cmd, UINT8 *param, UINT32 param_no, DSI_PACKET_TYPE pkt_type, BOOL b_eot)
{
	...
	if (pkt_type == DSI_SHORT_PACKET) {
		...
		//    ui_pkt_hd = 0x32;
#elif (DISPDEV_IFDSI_TYPE == DISPDEV_IFDSI_ST7701S)
		//if(ui_dsc_cmd == 0x35 && b_te_on == FALSE)
		//    ui_pkt_hd = 0x32;
#endif
		...
		//DSI_IND_MSG("emu_dsiLPWriteCmd ui_ecc_code = 0x%08x\r\n", (uint)ui_ecc_code);
