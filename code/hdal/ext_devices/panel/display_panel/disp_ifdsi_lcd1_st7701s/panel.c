...
#define ST7701S_IND_MSG(...)       debug_msg(__VA_ARGS__)

#define ST7701S_ERR_MSG(...)       debug_msg(__VA_ARGS__)

#define ST7701S_WRN_MSG(...)       debug_msg(__VA_ARGS__)
#define ST7701S_TE_OFF              0
#define ST7701S_TE_ON               1

#define ST7701S_TE_PACKET           0
#define ST7701S_TE_PIN              1

#define ST7701S_NEWPANEL            1
...
int panel_init(void)
{
    ...
    DBG_DUMP("Hello, panel: ST7701S\n");
    return 0;
}

void panel_exit(void)
{
    DBG_DUMP("ST7701S, Goodbye\r\n");
}
...
MODULE_DESCRIPTION("ST7701S Panel");
