...
#define GPIO_LCD_RESET2             S_GPIO_5
...
#define GPIO_RED_LED                L_GPIO_17//(1 | GPIO_IS_DGPIO)  //FPGA
#define PAD_RED_LED                 PAD_PIN_LGPIO17

#define LED_BLUE_DUMMY               0
#define LED_BLUE_BY_GPIO             1
#define LED_BLUE_BY_MCU              3
#define LED_BLUE_CTRL                LED_BLUE_DUMMY
#define GPIO_BLUE_LED                L_GPIO_14//(1 | GPIO_IS_DGPIO)  //FPGA
#define PAD_BLUE_LED                 PAD_PIN_LGPIO14
