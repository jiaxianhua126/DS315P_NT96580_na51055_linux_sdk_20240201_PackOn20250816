...
#define ASR_URL_PATH   "/mnt/sd/asr_url.txt"
#define ASR_SERIAL_PATH   "/mnt/sd/asr_serialnumber.txt"
// ASR Pstore
#define PS_ASR  "ASR"
#define SERIALNUMBER_MAXSIZE   24
#if Test_Param
//可以优化成数组
#define ASR_PARAM_PATH "/mnt/sd/asr_param.txt"
...
void Asr_Test_Param(void)
{
    ...
    if (test_fp == NULL) {
        printf("open /mnt/sd/asr_param fail \r\n");
    } else {
...
void Test_KW(char *param)
{
    ...
    if ((0 == strcmp(param,"kw1"))){
        kw1 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw1);
    } else if ((0 == strcmp(param,"kw2"))) {
        kw2 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw2);
    } else if ((0 == strcmp(param,"kw3"))) {
        kw3 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw3);
    } else if ((0 == strcmp(param,"kw4"))) {
        kw4 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw4);
    } else if ((0 == strcmp(param,"kw5"))) {
        kw5 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw5);
    } else if ((0 == strcmp(param,"kw6"))) {
        kw6 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw6);
    } else if ((0 == strcmp(param,"kw7"))) {
        kw7 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw7);
    } else if ((0 == strcmp(param,"kw8"))) {
        kw8 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw8);
    } else if ((0 == strcmp(param,"kw9"))) {
        kw9 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw9);
    } else if ((0 == strcmp(param,"kw10"))) {
        kw10 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw10);
    } else if ((0 == strcmp(param,"kw11"))) {
        kw11 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw11);
    } else if ((0 == strcmp(param,"kw12"))) {
        kw12 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw12);
    } else if ((0 == strcmp(param,"kw13"))) {
        kw13 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw13);
    } else if ((0 == strcmp(param,"kw14"))) {
        kw14 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw14);
    } else if ((0 == strcmp(param,"kw15"))) {
        kw15 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw15);
    } else if ((0 == strcmp(param,"kw16"))) {
        kw16 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw16);
    } else if ((0 == strcmp(param,"kw17"))) {
        kw17 ++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,kw17);
    } else if ((0 == strcmp(param,"wo yao pai zhao"))){
        ch1++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch1);
    } else if ((0 == strcmp(param,"wo yao lu xiang"))) {
        ch2++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch2);
    } else if ((0 == strcmp(param,"guan bi ping mu"))) {
        ch3++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch3);
    } else if ((0 == strcmp(param,"da kai ping mu"))) {
        ch4++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch4);
    } else if ((0 == strcmp(param,"da kai lu yin"))) {
        ch5++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch5);
    } else if ((0 == strcmp(param,"guan bi lu yin"))) {
        ch6++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch6);
    } else if ((0 == strcmp(param,"da kai re dian"))) {
        ch7++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch7);
    } else if ((0 == strcmp(param,"guan bi re dian"))) {
        ch8++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch8);
    } else if ((0 == strcmp(param,"da kai qian lu"))) {
        ch9++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch9);
    } else if ((0 == strcmp(param,"xian shi qian lu"))) {
        ch10++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch10);
    } else if ((0 == strcmp(param,"da kai hou lu"))) {
        ch11++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch11);
    }else if ((0 == strcmp(param,"xian shi hou lu"))) {
        ch12++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch12);
    }else if ((0 == strcmp(param,"zhua pai zhao pian"))) {
        ch13++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch13);
    }else if ((0 == strcmp(param,"da kai nei lu"))) {
        ch14++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch14);
    }else if ((0 == strcmp(param,"cha kan quan bu"))) {
        ch15++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch15);
    }else if ((0 == strcmp(param,"fan hui zhu ye"))) {
        ch16++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch16);
    }else if ((0 == strcmp(param,"shi pin jia suo"))) {
        ch17++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch17);
    } else if ((0 == strcmp(param,"da kai wai fa"))) {
        ch18++;
        sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch18);
    } else if ((0 == strcmp(param,"guan bi wai fa"))) {
        ch19++;
       sprintf(kw,"/mnt/sd/%s_%s_%d.txt",test_language,param,ch19);
    } 
...
int getSerialNumber(void *userdata, const char *url, char **response)
{
    ...
    if (!pASN.Asr_SerialNumber_Flag) {
        ...
        if (asr_url_fd < 0) {
            ...
            if (serial_fp  < 0) {
                printf("open serial_fp fail not /mnt/sd/asr_serialnumber.txt 11111\r\n");
            }
    ...
    if (!pASN.Asr_SerialNumber_Flag) {
        ...
        if (asr_serial_fd == NULL) {
            printf("open asr_serial_fd fail not /mnt/sd/asr_serialnumber.txt\r\n");
        } else {
