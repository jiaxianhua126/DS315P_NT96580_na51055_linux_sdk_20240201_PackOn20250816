...
#define SENSOR_MAP_4                    SENSOR_ID_4
...
#define SENSOR_GP_4                     SENSOR_MULTI_ID_NONE /*ex: SENSOR_MULTI_ID_3|SENSOR_MULTI_ID_4*/
// Sensor sub group
...
#if PHOTO_PREVIEW_SLICE_ENC_VER2_FUNC == ENABLE && PHOTO_PREVIEW_SLICE_ENC_FUNC == DISABLE
 ...
 *******************************************/
#if (_PACKAGE_HEIC_)
#define HEIC_FUNC						ENABLE
#else
#define HEIC_FUNC						DISABLE
#endif

#if HEIC_FUNC == ENABLE

/* for open source lib , it can't be drive name such as A: */
#if defined(_EMBMEM_EMMC_)
#define HEIC_STORAGE_ROOT				"/mnt/emmc1"
#else
#define HEIC_STORAGE_ROOT				"/mnt/sd"
#endif

#define HEIC_DCF_SUPPORT				ENABLE

#if HEIC_DCF_SUPPORT == ENABLE /* 8.3 naming , rename *.heci */

#define HEIC_TMP_EXT_NAME		".ASF"
#define HEIC_DCF_FILE_TYPE		DCF_FILE_TYPE_ASF

#else

#define HEIC_TMP_EXT_NAME		".HEIC"
