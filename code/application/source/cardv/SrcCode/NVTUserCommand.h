...
typedef enum {
	...
	NVTEVT_KEY_LONG_PRESS  = 0x11060120,
	NVTEVT_KEY_ACC_MODE  = 0x11060121,
	NVTEVT_KEY_POWER_ACC = 0x11060122,
	NVTEVT_KEY_EDOG_ALARM = 0x11060124, //Add for Edog Alarm	20170823
	NVTEVT_KEY_SOS,
	/* INSERT NEW EVENT HRER */
	...
	NVTEVT_KEY_LONG_RELEASE = 0x1106040f,
	NVTEVT_KEY_LONG_PRESS_REACH_CNT = 0x11060410,
...
typedef enum {
	...
	NVTEVT_UPDATE_LVGL          = 0x80000001, ///< Update lvgl task handel per 20 ms
#endif
