...
extern void System_InstallID(void);
extern void System_EnableSWReset(UINT32 param);
extern void System_CancelSWReset(void);
extern UINT32 System_GetSWResetParam(void);
extern void System_EnableHWResetByAlarmTime(UINT32 param, INT32 hour, INT32 min, INT32 sec);
extern void System_EnableHWReset(UINT32 param);
extern void System_CancelHWReset(void);
extern void System_WaitForPowerOnFinish(void); //Wait flag singal until System_PowerOnFinish is call.
extern void System_WaitForPowerOffStart(void); //Wait flag singal until System_PowerOffStart is call.
extern void System_PowerOnFinish(void); //Do power-on process to pass System_WaitForPowerOnFinish()
extern void System_PowerOffStart(void); //Do power-off process to pass System_WaitForPowerOffStart(), then do shutdown, or HW reset, or SW reset.
extern UINT32 System_GetPowerOnSource(void);
...
extern UINT32 System_SwtichAudioSetting(UINT32 setting);
extern UINT32 System_GetAudioSetting(void);
...
extern void System_ConnectDisplay(UINT32 DisplayMask);

extern void System_DisconnectDisplay(UINT32 DisplayMask);

extern void System_HideDisplay(UINT32 DevID);

extern void System_DetachDisplay(UINT32 DevID);

extern UINT32 System_GetConnectSensor(void);
extern UINT32 System_GetEnableSensor(void);
extern UINT32 System_GetPrevEnableSensor(void);
...
extern BOOL  System_GetShutdownBegin(void);
