...
//#NT#Add WiFiCmd Bitrate control.
	...
	NVTEVT_WIFI_EXE_SET_HDRDET_TIME,
//#NT#2016/12/02#Isiah Chang -end
	/* INSERT NEW EVENT HRER */
    NVTEVT_WIFI_EXE_MOVIE_TIMELAPSE_REC,
    NVTEVT_WIFI_EXE_MOVIE_METERING,
    NVTEVT_WIFI_EXE_MOVIE_BITRATE,
    NVTEVT_WIFI_EXE_MOVIE_GPS_STAMP,
    NVTEVT_WIFI_EXE_MOVIE_MODEL_STAMP,
    NVTEVT_WIFI_EXE_BEEP,
    NVTEVT_WIFI_EXE_SCREEN_SAVER,
    NVTEVT_WIFI_EXE_FREQUENCY,
    NVTEVT_WIFI_EXE_GPS,
    NVTEVT_WIFI_EXE_TIMEZONE,
    NVTEVT_WIFI_EXE_SPEEDUNIT,
    NVTEVT_WIFI_EXE_SENSOR_ROTATE,
    NVTEVT_WIFI_EXE_SENSOR2_ROTATE,
    NVTEVT_WIFI_EXE_CUSTOM_STAMP,
    NVTEVT_WIFI_EXE_FORMAT_WARNING,
    NVTEVT_WIFI_EXE_MOVIE_EV2,
    NVTEVT_WIFI_EXE_PARKING_MODE,
    NVTEVT_WIFI_EXE_SET_CARNO,
    NVTEVT_WIFI_EXE_SYSREBOOT,
    NVTEVT_WIFI_EXE_BOOTDELAY,
    NVTEVT_WIFI_EXE_IR_REAR_COLOR,
    NVTEVT_WIFI_EXE_REAR_SENSOR_MIRROR,
    NVTEVT_WIFI_EXE_MOVIE_CODEC,
    NVTEVT_WIFI_EXE_PARKING_GSENSOR,
    NVTEVT_WIFI_EXE_PARKING_MOTION_DET,
    NVTEVT_WIFI_EXE_SHUTDOWNTIMER,
    NVTEVT_WIFI_EXE_WATER_LOGO,
    NVTEVT_WIFI_EXE_SET_STORAGE_TYPE,
    NVTEVT_WIFI_EXE_SETUP_AMBIANCE_LED,
    NVTEVT_WIFI_EXE_CUSTOM_FWUPDATE,
    NVTEVT_WIFI_EXE_SEND_FW_MD5,
    NVTEVT_WIFI_EXE_VIDEO_FORMAT,
    NVTEVT_WIFI_EXE_LED,
    NVTEVT_WIFI_EXE_VOLUME,
    NVTEVT_WIFI_EXE_EDOGDATA_UPDATE,
    NVTEVT_WIFI_EXE_BAND,
    NVTEVT_WIFI_EXE_ENTER_PARK_TIMER,
    NVTEVT_WIFI_EXE_MOVIE_VOICE,
    NVTEVT_WIFI_EXE_MOVIE_MENU_COMING,
    NVTEVT_WIFI_EXE_PARKING_OFF_GPS,
    NVTEVT_WIFI_EXE_DATE_FORMAT,
    NVTEVT_WIFI_EXE_ASR_CONTROL,
    NVTEVT_WIFI_EXE_ASR_CONTENT,
}
CUSTOM_WIFI_EVENT;
