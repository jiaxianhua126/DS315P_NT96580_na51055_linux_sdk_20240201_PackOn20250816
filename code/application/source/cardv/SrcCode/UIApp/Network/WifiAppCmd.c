...
WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_VOICE, NVTEVT_WIFI_EXE_MOVIE_VOICE, 0, 0, FL_MOVIE_VOICE)
WIFI_CMD_ITEM(WIFIAPP_CMD_APP_MENU_COMING, NVTEVT_WIFI_EXE_MOVIE_MENU_COMING, 0, 0, FL_NULL)
...
WIFI_CMD_ITEM(WIFIAPP_CMD_ASR_CONTROL, NVTEVT_WIFI_EXE_ASR_CONTROL, 0, 0, FL_ASR)
WIFI_CMD_ITEM(WIFIAPP_CMD_ASR_CONTENT, NVTEVT_WIFI_EXE_ASR_CONTENT, 0, 0, FL_ASR_CONTENT)
