...
//HDR
//WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_HDR, NVTEVT_WIFI_EXE_MOVIE_HDR, 0, 0, FL_MOVIE_HDR_DET)
//WIFI_CMD_ITEM(WIFIAPP_CMD_SET_HDRDET_TIME, NVTEVT_WIFI_EXE_SET_HDRDET_TIME, 0, 0, FL_NULL)
//WIFI_CMD_ITEM(WIFIAPP_CMD_GET_HDRDET_TIME,		  0, (UINT32)XML_GetHdrTime, 			   0, FL_NULL)
...
WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_EV2, NVTEVT_WIFI_EXE_MOVIE_EV2, 0, WIFIFLAG_MODE_DONE, FL_EV2)
...
//WIFI_CMD_ITEM(WIFIAPP_CMD_PARKING_MOTION_DET, NVTEVT_WIFI_EXE_PARKING_MOTION_DET, 0, 0, FL_PARKING_MOTION_DET)
WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_AUDIO, NVTEVT_WIFI_EXE_MOVIE_AUDIO, 0, 0, FL_MOVIE_AUDIO)
WIFI_CMD_ITEM(WIFIAPP_CMD_WIFI_BAND, NVTEVT_WIFI_EXE_BAND, 0, 0, FL_WIFI)
WIFI_CMD_ITEM(WIFIAPP_CMD_WIFI_VOICE, NVTEVT_WIFI_EXE_MOVIE_VOICE, 0, 0, FL_MOVIE_VOICE)
WIFI_CMD_ITEM(WIFIAPP_CMD_WIFI_MENU_COMING, NVTEVT_WIFI_EXE_MOVIE_MENU_COMING, 0, 0, FL_NULL)
//WIFI_CMD_ITEM(WIFIAPP_CMD_WIFI_PARKING_OFF_GPS, NVTEVT_WIFI_EXE_PARKING_OFF_GPS, 0, 0, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_DATEFORMAT, NVTEVT_WIFI_EXE_DATE_FORMAT, 0, 0, FL_DATE_FORMAT)
WIFI_CMD_ITEM(WIFIAPP_CMD_WIFI_ASR_CONTROL, NVTEVT_WIFI_EXE_ASR_CONTROL, 0, 0, FL_ASR)
WIFI_CMD_ITEM(WIFIAPP_CMD_WIFI_ASR_CONTENT, NVTEVT_WIFI_EXE_ASR_CONTENT, 0, 0, FL_ASR_CONTENT)
...
//WIFI_CMD_ITEM(WIFIAPP_CMD_PARKING_GSENSOR, NVTEVT_WIFI_EXE_PARKING_GSENSOR, 0, 0, FL_PARKING_GSENSOR)
...
WIFI_CMD_ITEM(WIFIAPP_CMD_MODECHANGE, 0, (UINT32)XML_ChangeMode, 0, FL_NULL)
#else
...
WIFI_CMD_ITEM(WIFIAPP_CMD_FILELIST, 0, (UINT32)XML_MovieFileList, 0, FL_NULL) // XML_FileList
WIFI_CMD_ITEM(WIFIAPP_CMD_HEARTBEAT, NVTEVT_WIFI_EXE_HEARTBEAT, (UINT32)XML_GetHeartBeat, 0, FL_NULL)
...
//WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_TIMELAPSE_REC, NVTEVT_WIFI_EXE_MOVIE_TIMELAPSE_REC, 0, 0, FL_MOVIE_TIMELAPSE_REC)
//WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_METERING,      NVTEVT_WIFI_EXE_MOVIE_METERING,      0, 0, FL_METERING)
//WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_BITRATE,       NVTEVT_WIFI_EXE_MOVIE_BITRATE,       0, 0, FL_MOVIE_BITRATE)
WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_GPS_STAMP,     NVTEVT_WIFI_EXE_MOVIE_GPS_STAMP,     0, 0, FL_GPS_STAMP)
//WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_MODEL_STAMP,   NVTEVT_WIFI_EXE_MOVIE_MODEL_STAMP,   0, 0, FL_MODEL_STAMP)
WIFI_CMD_ITEM(WIFIAPP_CMD_BEEP,                NVTEVT_WIFI_EXE_BEEP,                0, 0, FL_BEEP)
WIFI_CMD_ITEM(WIFIAPP_CMD_SCREEN_SAVER,        NVTEVT_WIFI_EXE_SCREEN_SAVER,        0, 0, FL_LCD_OFF)
WIFI_CMD_ITEM(WIFIAPP_CMD_FREQUENCY,           NVTEVT_WIFI_EXE_FREQUENCY,           0, 0, FL_FREQUENCY)
WIFI_CMD_ITEM(WIFIAPP_CMD_GET_MODEL_NAME,      0, (UINT32)XML_GetModelName,            0, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_GET_CURRENT_MODE,    0, (UINT32)XML_GetCurrMode,             0, FL_NULL)
//WIFI_CMD_ITEM(WIFIAPP_CMD_GPS,                 NVTEVT_WIFI_EXE_GPS,                 0, 0, FL_GPS)
WIFI_CMD_ITEM(WIFIAPP_CMD_TIMEZONE,            NVTEVT_WIFI_EXE_TIMEZONE,            0, 0, FL_TIME_ZONE)
WIFI_CMD_ITEM(WIFIAPP_CMD_SPEEDUNIT,           NVTEVT_WIFI_EXE_SPEEDUNIT,           0, 0, FL_SPEED_UNIT)
//WIFI_CMD_ITEM(WIFIAPP_CMD_SENSOR_ROTATE,       NVTEVT_WIFI_EXE_SENSOR_ROTATE,       0, 0, FL_SENSOR_ROTATE)
//WIFI_CMD_ITEM(WIFIAPP_CMD_SENSOR2_ROTATE,      NVTEVT_WIFI_EXE_SENSOR2_ROTATE,      0, 0, FL_SENSOR2_ROTATE)
//WIFI_CMD_ITEM(WIFIAPP_CMD_CUSTOM_STAMP, 	   NVTEVT_WIFI_EXE_CUSTOM_STAMP,		0, 0, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_FORMAT_WARNING,      NVTEVT_WIFI_EXE_FORMAT_WARNING,      0, 0, FL_FORMAT_WARNING)
WIFI_CMD_ITEM(WIFIAPP_CMD_PARKING_MODE,        NVTEVT_WIFI_EXE_PARKING_MODE,        0, 0, FL_PARKING_MODE)
//WIFI_CMD_ITEM(WIFIAPP_CMD_SET_CARNO,           NVTEVT_WIFI_EXE_SET_CARNO,           0, 0, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_SYSREBOOT,           NVTEVT_WIFI_EXE_SYSREBOOT,           0, 0, FL_NULL)
//WIFI_CMD_ITEM(WIFIAPP_CMD_BOOTDELAY,           NVTEVT_WIFI_EXE_BOOTDELAY,           0, 0, FL_BOOT_DELAY)
//WIFI_CMD_ITEM(WIFIAPP_CMD_IR_REAR_COLOR,       NVTEVT_WIFI_EXE_IR_REAR_COLOR,       0, 0, FL_IR_REAR_COLOR)
WIFI_CMD_ITEM(WIFIAPP_CMD_REAR_SENSOR_MIRROR,  NVTEVT_WIFI_EXE_REAR_SENSOR_MIRROR,  0, 0, FL_REAR_SENSOR_MIRROR)
WIFI_CMD_ITEM(WIFIAPP_CMD_VIDEO_FORMAT, 	   NVTEVT_WIFI_EXE_VIDEO_FORMAT,		0, 0, FL_VIDEO_FORMAT)
//WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_CODEC,         NVTEVT_WIFI_EXE_MOVIE_CODEC,         0, 0, FL_MOVIE_CODEC)
//WIFI_CMD_ITEM(WIFIAPP_CMD_GET_CARNO,		   0, (UINT32)XML_GetCarNo, 			   0, FL_NULL)
//WIFI_CMD_ITEM(WIFIAPP_CMD_GET_CUSTOM_STAMP,    0, (UINT32)XML_GetCustomStamp,		   0, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_GET_GPS_STATUS,      0, (UINT32)XML_GetGPSStatus,            0, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_GET_SOS_STATUS,      0, (UINT32)XML_GetSOSStatus,            0, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_GET_SENSOR_STATUS,   0, (UINT32)XML_GetSensorStatus,         0, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_PHOTO_FILELIST,      0, (UINT32)XML_PhotoFileList,           0, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_RO_FILELIST,         0, (UINT32)XML_ROFileList,              0, FL_NULL)
//WIFI_CMD_ITEM(WIFIAPP_CMD_GET_GPS_DB,          0, (UINT32)XML_GetGPS_DB,               0, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_SEND_MD5,			   NVTEVT_WIFI_EXE_SEND_FW_MD5, 		0, 0, FL_NULL)
//WIFI_CMD_ITEM(WIFIAPP_CMD_LED,				   NVTEVT_WIFI_EXE_LED, 				0, 0, FL_LED)
WIFI_CMD_ITEM(WIFIAPP_CMD_VOLUME, 			   NVTEVT_WIFI_EXE_VOLUME,				0, 0, FL_VOLUME)
//WIFI_CMD_ITEM(WIFIAPP_CMD_PLAY_VOLUME,		   NVTEVT_WIFI_EXE_PLAY_VOLUME,			0, 0, FL_PLAY_VOLUME)
//WIFI_CMD_ITEM(WIFIAPP_CMD_SHUTDOWNTIMER,       NVTEVT_WIFI_EXE_SHUTDOWNTIMER,       0, 0, FL_SHUTDOWN_TIMER)
//WIFI_CMD_ITEM(WIFIAPP_CMD_WATER_LOGO, 		 NVTEVT_WIFI_EXE_WATER_LOGO,		  0, 0, FL_MODEL_STAMP)
//WIFI_CMD_ITEM(WIFIAPP_CMD_GET_GPS_STATUS, 	 0, (UINT32)XML_GetGPSStatus,			 0, FL_NULL)
//WIFI_CMD_ITEM(WIFIAPP_CMD_GET_SOS_STATUS, 	 0, (UINT32)XML_GetSOSStatus,			 0, FL_NULL)
//WIFI_CMD_ITEM(WIFIAPP_CMD_GET_SENSOR_STATUS,   0, (UINT32)XML_GetSensorStatus,         0, FL_NULL)
WIFI_CMD_ITEM(WIFIAPP_CMD_SYSREBOOT, 0, (UINT32)XML_SysReboot, 0, FL_NULL)
//WIFI_CMD_ITEM(WIFIAPP_CMD_SET_STORAGE_TYPE,    NVTEVT_WIFI_EXE_SET_STORAGE_TYPE, 0,0, FL_NULL)
//WIFI_CMD_ITEM(WIFIAPP_CMD_ENTER_PARK_TIMER,    NVTEVT_WIFI_EXE_ENTER_PARK_TIMER, 0,0, FL_ENTER_PARKING_TIMER)
