...
extern char g_LivestreamHotSpot_SSID[NVT_WSC_MAX_SSID_LEN];
extern char g_LivestreamHotSpot_PASSPHRASE[NVT_MAX_WEP_KEY_LEN];
extern char g_LivestreamRtmpAddress[512];
