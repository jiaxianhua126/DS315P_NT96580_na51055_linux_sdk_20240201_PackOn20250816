...
#define CFG_JPG_HEADER_SIZE (64*1024)       //64K ,exif
...
#define    CFG_THUMBNAIL_W     160
#define    CFG_THUMBNAIL_H     120

#if PHOTO_PREVIEW_SLICE_ENC_FUNC

#define UIAPP_PHOTO_SIZE_40M 		0
#define UIAPP_PHOTO_SIZE_12M 		1
#define UIAPP_PHOTO_SIZE_10M 		2
#define UIAPP_PHOTO_SIZE_8M 		3
#define UIAPP_PHOTO_SIZE_5M 		4
#define UIAPP_PHOTO_SIZE_3M 		5
#define UIAPP_PHOTO_SIZE_VGA 		6
#else
#define UIAPP_PHOTO_SIZE_12M 		0
#define UIAPP_PHOTO_SIZE_10M 		1
#define UIAPP_PHOTO_SIZE_8M 		2
#define UIAPP_PHOTO_SIZE_5M 		3
#define UIAPP_PHOTO_SIZE_3M 		4
#define UIAPP_PHOTO_SIZE_VGA 		5
#endif

#if (SENSOR_CAPS_COUNT >= 2)
#define    PHOTO_MAX_CAP_SIZE  UIAPP_PHOTO_SIZE_8M
#else
	#if PHOTO_PREVIEW_SLICE_ENC_FUNC
		#define    PHOTO_MAX_CAP_SIZE  					UIAPP_PHOTO_SIZE_40M	/* Max slice encode size */
		#define	   PHOTO_MIN_CAP_SIZE  					UIAPP_PHOTO_SIZE_VGA		/* UI Menu only display options which size is larger than PHOTO_SLICE_ENC_MIN_CAP_SIZE */
	#else
		#define    PHOTO_MAX_CAP_SIZE  UIAPP_PHOTO_SIZE_8M
	#endif
#endif
...
#define CFG_JPG_PREVIEW_SLICE_ENC_INIT_QUALITY_PRIMARY		80
...
#define CFG_JPG_PREVIEW_SLICE_ENC_HEIC_BITRATE					(1024 * 1024 * 8)
#define CFG_JPG_PREVIEW_SLICE_ENC_HEIC_INIT_QP					0
#define CFG_JPG_PREVIEW_SLICE_ENC_HEIC_WIDTH					1920
#define CFG_JPG_PREVIEW_SLICE_ENC_HEIC_HEIGHT					1080

#if (CFG_JPG_PREVIEW_SLICE_ENC_HEIC_WIDTH * CFG_JPG_PREVIEW_SLICE_ENC_HEIC_HEIGHT) > (CFG_JPG_PREVIEW_SLICE_ENC_PRIMARY_BUF_WIDTH * CFG_JPG_PREVIEW_SLICE_ENC_PRIMARY_BUF_HEIGHT)
#error "please enlarge CFG_PHOTOFAST_SLICE_ENC_PRIMARY_BUF_WIDTH and CFG_PHOTOFAST_SLICE_ENC_PRIMARY_BUF_HEIGHT for HEIC"
#endif
...
#define JPG_COMERESSED_RATIO_8  (8)
#define JPG_COMERESSED_RATIO_9  (9)
#define JPG_COMERESSED_RATIO_10  (10)
#define JPG_COMERESSED_RATIO_11  (11)
#define JPG_COMERESSED_RATIO_12  (12)
#define JPG_COMERESSED_RATIO_13  (13)
#define JPG_COMERESSED_RATIO_14  (14)
#define JPG_COMERESSED_RATIO_15  (15)
#define JPG_COMERESSED_RATIO_16  (16)
#define JPG_COMERESSED_RATIO_17  (17)
#define JPG_COMERESSED_RATIO_18  (18)
#define JPG_COMERESSED_RATIO_19  (19)
#define JPG_COMERESSED_RATIO_20  (20)
...
typedef enum {
	PHOTO_ENC_JPG_PRIMARY = 0,
    PHOTO_ENC_JPG_SCREENNAIL,		
    PHOTO_ENC_JPG_THUMBNAIL,
...
typedef enum {
	...
	NVTEVT_EXE_SLICE_ENCODE     = 0x1400200c,
...
extern void PhotoExe_SetCapYUV420En(BOOL Enable);
extern BOOL PhotoExe_GetCapYUV420En(void);
