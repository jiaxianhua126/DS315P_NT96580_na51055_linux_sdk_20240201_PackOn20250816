...
lv_obj_t* UIFlowWifiWait_create(){
	...
	STYLE_COLOR_PROP(0x00, 0x55, 0x1f, 0x57) ; lv_style_set_bg_color(&container_1_s0, LV_STATE_DEFAULT, color);
	...
	STYLE_COLOR_PROP(0x00, 0x55, 0x1f, 0x57) ; lv_style_set_bg_color(&container_1_s0, LV_STATE_CHECKED, color);
	...
	STYLE_COLOR_PROP(0x00, 0x55, 0x1f, 0x57) ; lv_style_set_bg_color(&container_1_s0, LV_STATE_FOCUSED, color);
	...
	STYLE_COLOR_PROP(0x00, 0x55, 0x1f, 0x57) ; lv_style_set_bg_color(&container_1_s0, LV_STATE_EDITED, color);
	...
	STYLE_COLOR_PROP(0x00, 0x55, 0x1f, 0x57) ; lv_style_set_bg_color(&container_1_s0, LV_STATE_HOVERED, color);
	...
	STYLE_COLOR_PROP(0x00, 0x55, 0x1f, 0x57) ; lv_style_set_bg_color(&container_1_s0, LV_STATE_PRESSED, color);
	...
	STYLE_COLOR_PROP(0x00, 0x55, 0x1f, 0x57) ; lv_style_set_bg_color(&container_1_s0, LV_STATE_DISABLED, color);
	...
	lv_obj_set_size(container_1, 620, 240);
	...
	lv_obj_set_pos(image_wifi, 250, 86);
	lv_obj_set_size(image_wifi, 86, 66);
	lv_img_set_src(image_wifi, &icon_wifi_on_m);
	...
	lv_style_set_line_opa(&spinner_1_s0,LV_STATE_DEFAULT,255);
	lv_style_set_line_width(&spinner_1_s0,LV_STATE_DEFAULT,4);
	...
	STYLE_COLOR_PROP(0x02, 0xff, 0xff, 0xff) ; lv_style_set_line_color(&spinner_1_s1, LV_STATE_DEFAULT, color);
	lv_style_set_line_opa(&spinner_1_s1,LV_STATE_DEFAULT,255);
	lv_style_set_line_width(&spinner_1_s1,LV_STATE_DEFAULT,4);
	STYLE_COLOR_PROP(0x02, 0xff, 0xff, 0xff) ; lv_style_set_line_color(&spinner_1_s1, LV_STATE_CHECKED, color);
	STYLE_COLOR_PROP(0x02, 0xff, 0xff, 0xff) ; lv_style_set_line_color(&spinner_1_s1, LV_STATE_FOCUSED, color);
	STYLE_COLOR_PROP(0x02, 0xff, 0xff, 0xff) ; lv_style_set_line_color(&spinner_1_s1, LV_STATE_EDITED, color);
	STYLE_COLOR_PROP(0x02, 0xff, 0xff, 0xff) ; lv_style_set_line_color(&spinner_1_s1, LV_STATE_HOVERED, color);
	STYLE_COLOR_PROP(0x02, 0xff, 0xff, 0xff) ; lv_style_set_line_color(&spinner_1_s1, LV_STATE_PRESSED, color);
	STYLE_COLOR_PROP(0x02, 0xff, 0xff, 0xff) ; lv_style_set_line_color(&spinner_1_s1, LV_STATE_DISABLED, color);
	lv_obj_t *spinner_1 = lv_spinner_create(parent, NULL);
	lv_obj_set_hidden(spinner_1, true);
	lv_obj_set_click(spinner_1, true);
	lv_obj_set_drag(spinner_1, false);
	lv_obj_set_pos(spinner_1, 360, 118);
	lv_obj_set_size(spinner_1, 32, 32);
	lv_spinner_set_dir(spinner_1, LV_SPINNER_DIR_FORWARD);
	lv_spinner_set_spin_time(spinner_1, 1000);
	lv_spinner_set_arc_length(spinner_1, 40);
	...
	lv_obj_set_hidden(container_2, true);
	lv_obj_set_click(container_2, true);
	lv_obj_set_drag(container_2, false);
	lv_obj_set_pos(container_2, 0, 0);
	lv_obj_set_size(container_2, 1, 1);
	...
	STYLE_COLOR_PROP(0x01, 0x00, 0x00, 0x00) ; lv_style_set_image_recolor(&image_cap_s0, LV_STATE_DEFAULT, color);
	...
	STYLE_COLOR_PROP(0x01, 0x00, 0x00, 0x00) ; lv_style_set_image_recolor(&image_cap_s0, LV_STATE_CHECKED, color);
	...
	STYLE_COLOR_PROP(0x01, 0x00, 0x00, 0x00) ; lv_style_set_image_recolor(&image_cap_s0, LV_STATE_FOCUSED, color);
	...
	STYLE_COLOR_PROP(0x01, 0x00, 0x00, 0x00) ; lv_style_set_image_recolor(&image_cap_s0, LV_STATE_EDITED, color);
	...
	STYLE_COLOR_PROP(0x01, 0x00, 0x00, 0x00) ; lv_style_set_image_recolor(&image_cap_s0, LV_STATE_HOVERED, color);
	...
	STYLE_COLOR_PROP(0x01, 0x00, 0x00, 0x00) ; lv_style_set_image_recolor(&image_cap_s0, LV_STATE_PRESSED, color);
	...
	STYLE_COLOR_PROP(0x01, 0x00, 0x00, 0x00) ; lv_style_set_image_recolor(&image_cap_s0, LV_STATE_DISABLED, color);
	lv_obj_t *image_cap = lv_img_create(parent, NULL);
	lv_obj_set_hidden(image_cap, true);
	lv_obj_set_click(image_cap, false);
	lv_obj_set_drag(image_cap, false);
	lv_obj_set_pos(image_cap, 0, 0);
	lv_obj_set_size(image_cap, 28, 28);
	lv_img_set_src(image_cap, &icon_mode_playback);
	...
	STYLE_COLOR_PROP(0x01, 0x00, 0x00, 0x00) ; lv_style_set_image_recolor(&image_con_s0, LV_STATE_DEFAULT, color);
	...
	STYLE_COLOR_PROP(0x01, 0x00, 0x00, 0x00) ; lv_style_set_image_recolor(&image_con_s0, LV_STATE_CHECKED, color);
	...
	STYLE_COLOR_PROP(0x01, 0x00, 0x00, 0x00) ; lv_style_set_image_recolor(&image_con_s0, LV_STATE_FOCUSED, color);
	...
	STYLE_COLOR_PROP(0x01, 0x00, 0x00, 0x00) ; lv_style_set_image_recolor(&image_con_s0, LV_STATE_EDITED, color);
	...
	STYLE_COLOR_PROP(0x01, 0x00, 0x00, 0x00) ; lv_style_set_image_recolor(&image_con_s0, LV_STATE_HOVERED, color);
	...
	STYLE_COLOR_PROP(0x01, 0x00, 0x00, 0x00) ; lv_style_set_image_recolor(&image_con_s0, LV_STATE_PRESSED, color);
	...
	STYLE_COLOR_PROP(0x01, 0x00, 0x00, 0x00) ; lv_style_set_image_recolor(&image_con_s0, LV_STATE_DISABLED, color);
	lv_obj_t *image_con = lv_img_create(parent, NULL);
	lv_obj_set_hidden(image_con, false);
	lv_obj_set_click(image_con, false);
	lv_obj_set_drag(image_con, false);
	lv_obj_set_pos(image_con, 246, 70);
	lv_obj_set_size(image_con, 127, 100);
	lv_img_set_src(image_con, &icon_wifi_connect);
