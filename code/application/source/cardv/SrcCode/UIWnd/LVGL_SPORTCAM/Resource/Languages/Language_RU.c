...
lv_plugin_string_t lv_plugin_RU_string_table[] = {
	...
	{ "Фильтр \"\"красных глаз\"\"", 44 },			/* LV_PLUGIN_STRING_ID_STRID_REDEYE */ 
	...
	{ "SD карта", 13 },			/* LV_PLUGIN_STRING_ID_STRID_EXT_CARD */ 
	...
	{ "На SD карту памяти", 31 },			/* LV_PLUGIN_STRING_ID_STRID_TOSD */ 
	...
	{ "Распознавание движения", 43 },			/* LV_PLUGIN_STRING_ID_STRID_MOTION_DET */ 
	...
	{ "Пожалуйста, вставьте SD-КАРТЫ", 52 },			/* LV_PLUGIN_STRING_ID_STRID_PLEASE_INSERT_SD */ 
