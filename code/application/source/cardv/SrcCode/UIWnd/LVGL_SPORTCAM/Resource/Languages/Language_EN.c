...
lv_plugin_string_t lv_plugin_EN_string_table[] = {
	{ NULL, 0 },
	...
	{ "Super Fine", 10 },			/* LV_PLUGIN_STRING_ID_STRID_SUPER */ 
	{ "Fine", 4 },			/* LV_PLUGIN_STRING_ID_STRID_FINE */ 
	{ "Normal", 6 },			/* LV_PLUGIN_STRING_ID_STRID_NORMAL */ 
	{ "Economy", 7 },			/* LV_PLUGIN_STRING_ID_STRID_ECONOMY */ 
	{ "White Balance", 13 },			/* LV_PLUGIN_STRING_ID_STRID_WB */ 
	{ "Auto", 4 },			/* LV_PLUGIN_STRING_ID_STRID_AUTO */ 
	{ "Daylight", 8 },			/* LV_PLUGIN_STRING_ID_STRID_WB_DAY */ 
	{ "Cloudy", 6 },			/* LV_PLUGIN_STRING_ID_STRID_WB_CLOUDY */ 
	{ "Tungsten", 8 },			/* LV_PLUGIN_STRING_ID_STRID_WB_TUNGSTEN */ 
	{ "Fluorescent", 11 },			/* LV_PLUGIN_STRING_ID_STRID_WB_FLUORESCENT */ 
	{ "Exposure", 8 },			/* LV_PLUGIN_STRING_ID_STRID_EXPOSURE */ 
	...
	{ "Scene Mode", 10 },			/* LV_PLUGIN_STRING_ID_STRID_SCENESETTING */ 
	{ "Scene", 5 },			/* LV_PLUGIN_STRING_ID_STRID_SCENE */ 
	{ "Landscape", 9 },			/* LV_PLUGIN_STRING_ID_STRID_LANDSCAPE */ 
	...
	{ "Smart Mode", 10 },			/* LV_PLUGIN_STRING_ID_STRID_SMART */ 
	...
	{ "Sharpness", 9 },			/* LV_PLUGIN_STRING_ID_STRID_SHARPNESS */ 
	{ "Strong", 6 },			/* LV_PLUGIN_STRING_ID_STRID_STRONG */ 
	{ "Soft", 4 },			/* LV_PLUGIN_STRING_ID_STRID_SOFT */ 
	{ "Low", 3 },			/* LV_PLUGIN_STRING_ID_STRID_LOW */ 
	{ "Medium", 6 },			/* LV_PLUGIN_STRING_ID_STRID_MED */ 
	{ "High", 4 },			/* LV_PLUGIN_STRING_ID_STRID_HIGH */ 
	{ "Date Stamp", 10 },			/* LV_PLUGIN_STRING_ID_STRID_DATE_STAMP */ 
	{ "Date/Time", 9 },			/* LV_PLUGIN_STRING_ID_STRID_DATE_TIME */ 
	{ "Date", 4 },			/* LV_PLUGIN_STRING_ID_STRID_DATE */ 
	{ "Time", 4 },			/* LV_PLUGIN_STRING_ID_STRID_TIME */ 
	...
	{ "Quick Review", 12 },			/* LV_PLUGIN_STRING_ID_STRID_QUICK_VIEW */ 
	...
	{ "Setup", 5 },			/* LV_PLUGIN_STRING_ID_STRID_SETUP */ 
	...
	{ "Storage Media", 13 },			/* LV_PLUGIN_STRING_ID_STRID_STORAGE */ 
	{ "Internal Memory", 15 },			/* LV_PLUGIN_STRING_ID_STRID_INT_FLASH */ 
	{ "TF Card", 7 },			/* LV_PLUGIN_STRING_ID_STRID_EXT_CARD */ 
	{ "Logo Display", 12 },			/* LV_PLUGIN_STRING_ID_STRID_LOGO_DISPLAY */ 
	{ "Opening", 7 },			/* LV_PLUGIN_STRING_ID_STRID_OPENING */ 
	{ "Format", 6 },			/* LV_PLUGIN_STRING_ID_STRID_FORMAT */ 
	{ "OK", 2 },			/* LV_PLUGIN_STRING_ID_STRID_OK */ 
	{ "Cancel", 6 },			/* LV_PLUGIN_STRING_ID_STRID_CANCEL */ 
	{ "Beep Sound", 10 },			/* LV_PLUGIN_STRING_ID_STRID_BEEPER */ 
	{ "Louder", 6 },			/* LV_PLUGIN_STRING_ID_STRID_BEEP_LOUD */ 
	{ "Soft", 4 },			/* LV_PLUGIN_STRING_ID_STRID_BEEP_SOFT */ 
	{ "Language", 8 },			/* LV_PLUGIN_STRING_ID_STRID_LANGUAGE */ 
	...
	{ "1 Minute", 8 },			/* LV_PLUGIN_STRING_ID_STRID_AUTO_OFF_1MIN */ 
	{ "2 Minutes", 9 },			/* LV_PLUGIN_STRING_ID_STRID_AUTO_OFF_2MIN */ 
	{ "3 Minutes", 9 },			/* LV_PLUGIN_STRING_ID_STRID_AUTO_OFF_3MIN */ 
	{ "5 Minutes", 9 },			/* LV_PLUGIN_STRING_ID_STRID_AUTO_OFF_5MIN */ 
	{ "10 Minutes", 10 },			/* LV_PLUGIN_STRING_ID_STRID_AUTO_OFF_10MIN */ 
	{ "1 Minute", 8 },			/* LV_PLUGIN_STRING_ID_STRID_1MIN */ 
	{ "2 Minutes", 9 },			/* LV_PLUGIN_STRING_ID_STRID_2MIN */ 
	{ "3 Minutes", 9 },			/* LV_PLUGIN_STRING_ID_STRID_3MIN */ 
	{ "5 Minutes", 9 },			/* LV_PLUGIN_STRING_ID_STRID_5MIN */ 
	{ "10 Minutes", 10 },			/* LV_PLUGIN_STRING_ID_STRID_10MIN */ 
	{ "15 Minutes", 10 },			/* LV_PLUGIN_STRING_ID_STRID_15MIN */ 
	{ "20 Minutes", 10 },			/* LV_PLUGIN_STRING_ID_STRID_20MIN */ 
	{ "25 Minutes", 10 },			/* LV_PLUGIN_STRING_ID_STRID_25MIN */ 
	{ "30 Minutes", 10 },			/* LV_PLUGIN_STRING_ID_STRID_30MIN */ 
	{ "Loop recording", 14 },			/* LV_PLUGIN_STRING_ID_STRID_CYCLIC_REC */ 
	...
	{ "Default Setting", 15 },			/* LV_PLUGIN_STRING_ID_STRID_DEFAULT_SETTING */ 
	...
	{ "2 Seconds", 9 },			/* LV_PLUGIN_STRING_ID_STRID_2SEC */ 
	{ "3 Seconds", 9 },			/* LV_PLUGIN_STRING_ID_STRID_3SEC */ 
	{ "5 Seconds", 9 },			/* LV_PLUGIN_STRING_ID_STRID_5SEC */ 
	{ "8 Seconds", 9 },			/* LV_PLUGIN_STRING_ID_STRID_8SEC */ 
	{ "10 Seconds", 10 },			/* LV_PLUGIN_STRING_ID_STRID_10SEC */ 
	{ "Protect", 7 },			/* LV_PLUGIN_STRING_ID_STRID_PROTECT */ 
	...
	{ "All Images", 10 },			/* LV_PLUGIN_STRING_ID_STRID_ALL_IMAGES */ 
	{ "This Image", 10 },			/* LV_PLUGIN_STRING_ID_STRID_THIS_IMAGE */ 
	{ "This Video", 10 },			/* LV_PLUGIN_STRING_ID_STRID_THIS_VIDEO */ 
	{ "Select Images", 13 },			/* LV_PLUGIN_STRING_ID_STRID_SELECT_IMAGES */ 
	{ "All Index", 9 },			/* LV_PLUGIN_STRING_ID_STRID_ALL_INDEX */ 
	{ "All", 3 },			/* LV_PLUGIN_STRING_ID_STRID_ALL */ 
	...
	{ "Copy To Card", 12 },			/* LV_PLUGIN_STRING_ID_STRID_COPY_TO_CARD */ 
	{ "Copy From Card", 14 },			/* LV_PLUGIN_STRING_ID_STRID_COPY_FROM_CARD */ 
	{ "Copy", 4 },			/* LV_PLUGIN_STRING_ID_STRID_COPY */ 
	{ "To TF", 5 },			/* LV_PLUGIN_STRING_ID_STRID_TOSD */ 
	...
	{ "Data Processed", 14 },			/* LV_PLUGIN_STRING_ID_STRID_DATAPROCESSED */ 
	...
	{ "Size", 4 },			/* LV_PLUGIN_STRING_ID_STRID_SIZE */ 
	{ "Standard", 8 },			/* LV_PLUGIN_STRING_ID_STRID_STANDARD */ 
	{ "Continue", 8 },			/* LV_PLUGIN_STRING_ID_STRID_CONTINUE */ 
	{ "Without", 7 },			/* LV_PLUGIN_STRING_ID_STRID_WITHOUT */ 
	{ "With", 4 },			/* LV_PLUGIN_STRING_ID_STRID_WITH */ 
	{ "File Name", 9 },			/* LV_PLUGIN_STRING_ID_STRID_NAME */ 
	{ "No Image", 8 },			/* LV_PLUGIN_STRING_ID_STRID_NO_IMAGE */ 
	{ "Set", 3 },			/* LV_PLUGIN_STRING_ID_STRID_SET */ 
	{ "Internal Memory Full", 20 },			/* LV_PLUGIN_STRING_ID_STRID_MEMORY_FULL */ 
	{ "Card Full", 9 },			/* LV_PLUGIN_STRING_ID_STRID_CARD_FULL */ 
	...
	{ "Card Protected", 14 },			/* LV_PLUGIN_STRING_ID_STRID_CARD_LOCKED */ 
	{ "Protected!", 10 },			/* LV_PLUGIN_STRING_ID_STRID_FILE_PROTECT */ 
	{ "Picture error", 13 },			/* LV_PLUGIN_STRING_ID_STRID_PICTUREERROR */ 
	{ "Low Battery", 11 },			/* LV_PLUGIN_STRING_ID_STRID_BATTERY_LOW */ 
	...
	{ "Date Stamping", 13 },			/* LV_PLUGIN_STRING_ID_STRID_DATE_STAMPING */ 
	{ "File Name", 9 },			/* LV_PLUGIN_STRING_ID_STRID_FILE_NAME */ 
	{ "No.Of Copy", 10 },			/* LV_PLUGIN_STRING_ID_STRID_NO_OF_COPY */ 
	{ "Default", 7 },			/* LV_PLUGIN_STRING_ID_STRID_DEFAULT */ 
	{ "Menu", 4 },			/* LV_PLUGIN_STRING_ID_STRID_MENU */ 
	{ "Exit", 4 },			/* LV_PLUGIN_STRING_ID_STRID_EXIT */ 
	{ "Please wait", 11 },			/* LV_PLUGIN_STRING_ID_STRID_PLEASE_WAIT */ 
	...
	{ "No Card", 7 },			/* LV_PLUGIN_STRING_ID_STRID_NO_CARD */ 
	...
	{ "Still", 5 },			/* LV_PLUGIN_STRING_ID_STRID_STILL */ 
	...
	{ "All data will be deleted", 24 },			/* LV_PLUGIN_STRING_ID_STRID_DELETE_WARNING */ 
	{ "Sequence No.", 12 },			/* LV_PLUGIN_STRING_ID_STRID_SEQUENCE_NO */ 
	{ "Return camera settings\nto defaults", 35 },			/* LV_PLUGIN_STRING_ID_STRID_RESET_WARNING */ 
	{ "Erase This?", 11 },			/* LV_PLUGIN_STRING_ID_STRID_ERASE_THIS */ 
	{ "Erase All Images?", 17 },			/* LV_PLUGIN_STRING_ID_STRID_ERASE_ALL */ 
	{ "Images", 6 },			/* LV_PLUGIN_STRING_ID_STRID_IMAGES */ 
	{ "Please connect to device", 24 },			/* LV_PLUGIN_STRING_ID_STRID_CONNECT_TO_DEVICE */ 
	{ "Device is connected", 19 },			/* LV_PLUGIN_STRING_ID_STRID_DEVICE_IS_CONNECTED */ 
	{ "Link Error", 10 },			/* LV_PLUGIN_STRING_ID_STRID_LINK_ERROR */ 
	{ "USB Error", 9 },			/* LV_PLUGIN_STRING_ID_STRID_USB_ERROR */ 
	...
	{ "Print All", 9 },			/* LV_PLUGIN_STRING_ID_STRID_PRINT_ALL */ 
	{ "Print Index", 11 },			/* LV_PLUGIN_STRING_ID_STRID_PRINT_INDEX */ 
	{ "Print DPOF", 10 },			/* LV_PLUGIN_STRING_ID_STRID_PRINT_DPOF */ 
	{ "Print Setting", 13 },			/* LV_PLUGIN_STRING_ID_STRID_PRINT_SETTING */ 
	{ "DPOF Restart", 12 },			/* LV_PLUGIN_STRING_ID_STRID_DPOF_RESTART */ 
	{ "Print", 5 },			/* LV_PLUGIN_STRING_ID_STRID_PRINT */ 
	{ "Start Printing", 14 },			/* LV_PLUGIN_STRING_ID_STRID_START_PRINTING */ 
	{ "Printing..", 10 },			/* LV_PLUGIN_STRING_ID_STRID_PRINTING */ 
	{ "Print Canceled", 14 },			/* LV_PLUGIN_STRING_ID_STRID_PRINT_CANCELED */ 
	{ "Print Finished", 14 },			/* LV_PLUGIN_STRING_ID_STRID_PRINT_FINISHED */ 
	{ "Press OK to Print", 17 },			/* LV_PLUGIN_STRING_ID_STRID_OK_TO_PRINT */ 
	{ "Paper Size", 10 },			/* LV_PLUGIN_STRING_ID_STRID_PAPER_SIZE */ 
	{ "L", 1 },			/* LV_PLUGIN_STRING_ID_STRID_L */ 
	{ "2L", 2 },			/* LV_PLUGIN_STRING_ID_STRID_2L */ 
	{ "Postcard ", 9 },			/* LV_PLUGIN_STRING_ID_STRID_POSTCARD */ 
	{ "Card", 4 },			/* LV_PLUGIN_STRING_ID_STRID_CARD */ 
	{ "100x150", 7 },			/* LV_PLUGIN_STRING_ID_STRID_100X150 */ 
	{ "4\"x6\"", 7 },			/* LV_PLUGIN_STRING_ID_STRID_4X6 */ 
	{ "8\"x10\"", 8 },			/* LV_PLUGIN_STRING_ID_STRID_8X10 */ 
	{ "Letter", 6 },			/* LV_PLUGIN_STRING_ID_STRID_LETTER */ 
	...
	{ "Date Print", 10 },			/* LV_PLUGIN_STRING_ID_STRID_DATE_PRINT */ 
	...
	{ "Cropping", 8 },			/* LV_PLUGIN_STRING_ID_STRID_CROPPING */ 
	...
	{ "Paper Error", 11 },			/* LV_PLUGIN_STRING_ID_STRID_PAPER_ERROR */ 
	{ "Paper is Empty", 14 },			/* LV_PLUGIN_STRING_ID_STRID_PAPER_OUT */ 
	{ "Paper is not Loaded", 19 },			/* LV_PLUGIN_STRING_ID_STRID_PAPER_LOAD_ERROR */ 
	{ "Paper is not Ejected", 20 },			/* LV_PLUGIN_STRING_ID_STRID_PAPER_EJECT_ERROR */ 
	{ "Paper is not Detected", 21 },			/* LV_PLUGIN_STRING_ID_STRID_PAPER_MEDIA_ERROR */ 
	{ "Paper is Jammed", 15 },			/* LV_PLUGIN_STRING_ID_STRID_PAPER_JAMMED */ 
	{ "Paper is Nearly Empty", 21 },			/* LV_PLUGIN_STRING_ID_STRID_PAPER_NEAR_EMPTY */ 
	{ "Paper Type is not Supported", 27 },			/* LV_PLUGIN_STRING_ID_STRID_PAPER_NOT_SUPPORT */ 
	{ "Ink Error", 9 },			/* LV_PLUGIN_STRING_ID_STRID_INK_ERROR */ 
	{ "Ink is Empty", 12 },			/* LV_PLUGIN_STRING_ID_STRID_INK_EMPTY */ 
	{ "Ink is Low", 10 },			/* LV_PLUGIN_STRING_ID_STRID_INK_LOW */ 
	{ "Waste Ink Reservoir Full", 24 },			/* LV_PLUGIN_STRING_ID_STRID_INK_WASTE */ 
	{ "Hardware Error", 14 },			/* LV_PLUGIN_STRING_ID_STRID_HW_ERROR */ 
	{ "Fatal Error", 11 },			/* LV_PLUGIN_STRING_ID_STRID_HW_FATAL */ 
	{ "Service Call", 12 },			/* LV_PLUGIN_STRING_ID_STRID_HW_SERVICE_CALL */ 
	{ "Printer Unavailable", 19 },			/* LV_PLUGIN_STRING_ID_STRID_HW_UNAVAILABLE */ 
	{ "Printer is Busy", 15 },			/* LV_PLUGIN_STRING_ID_STRID_HW_BUSY */ 
	{ "Lever Error", 11 },			/* LV_PLUGIN_STRING_ID_STRID_HW_LEVER */ 
	{ "Cover is Open", 13 },			/* LV_PLUGIN_STRING_ID_STRID_HW_COVER_OPEN */ 
	{ "No Marking Agent", 16 },			/* LV_PLUGIN_STRING_ID_STRID_HW_NO_MARKING_AGENT */ 
	{ "Ink Cover is Open", 17 },			/* LV_PLUGIN_STRING_ID_STRID_HW_INK_COVER_OPEN */ 
	{ "Ink Cartridge is not Set", 24 },			/* LV_PLUGIN_STRING_ID_STRID_HW_NO_INK_CARTRIDGE */ 
	{ "File Error", 10 },			/* LV_PLUGIN_STRING_ID_STRID_FILE_ERROR */ 
	{ "Print Info Error", 16 },			/* LV_PLUGIN_STRING_ID_STRID_FILE_PRINT_INFO */ 
	{ "File Decode Error", 17 },			/* LV_PLUGIN_STRING_ID_STRID_FILE_DECODE_ERROR */ 
	{ "Unknow Error", 12 },			/* LV_PLUGIN_STRING_ID_STRID_UNKNOW_ERROR */ 
	{ "XML Syntax Error", 16 },			/* LV_PLUGIN_STRING_ID_STRID_XML_SYNTAX_ERROR */ 
	{ "Motion Detection", 16 },			/* LV_PLUGIN_STRING_ID_STRID_MOTION_DET */ 
	{ "Face Detection", 14 },			/* LV_PLUGIN_STRING_ID_STRID_FACE_DET */ 
	{ "Smile Detection", 15 },			/* LV_PLUGIN_STRING_ID_STRID_SMILE_DET */ 
	{ "Anti-Shaking", 12 },			/* LV_PLUGIN_STRING_ID_STRID_ANTI_SHAKING */ 
	{ "No Movie", 8 },			/* LV_PLUGIN_STRING_ID_STRID_NO_MOVIE */ 
	{ "MP3", 3 },			/* LV_PLUGIN_STRING_ID_STRID_MP3PLAY */ 
	{ "No MP3 File", 11 },			/* LV_PLUGIN_STRING_ID_STRID_NO_MP3FILE */ 
	{ "Image rotation", 14 },			/* LV_PLUGIN_STRING_ID_STRID_SENSOR_ROTATE */ 
	{ "Video Record", 12 },			/* LV_PLUGIN_STRING_ID_STRID_RECORD */ 
	{ "Record Audio", 12 },			/* LV_PLUGIN_STRING_ID_STRID_RECORD_AUDIO */ 
	{ "Lamp setting", 12 },			/* LV_PLUGIN_STRING_ID_STRID_LED_SETTING */ 
	{ "Goodbye", 7 },			/* LV_PLUGIN_STRING_ID_STRID_GOOD_BYE */ 
	{ "PLEASE INSERT TF CARD", 21 },			/* LV_PLUGIN_STRING_ID_STRID_PLEASE_INSERT_SD */ 
	...
	{ "Screen Saver", 12 },			/* LV_PLUGIN_STRING_ID_STRID_SCREEN_SAVER */ 
	...
	{ "Time-lapse", 10 },			/* LV_PLUGIN_STRING_ID_STRID_TIMER_LAPSE */ 
	...
	{ "To ensure the safety and quality of video,please format the Mirco SD card", 73 },			/* LV_PLUGIN_STRING_ID_STRID_FORMAT_WARNING1 */ 
	...
	{ "Driving Safety", 14 },			/* LV_PLUGIN_STRING_ID_STRID_CAR_SAFE */ 
	{ "Traffic Sign Recognition", 24 },			/* LV_PLUGIN_STRING_ID_STRID_TSR */ 
	{ "REC :", 5 },			/* LV_PLUGIN_STRING_ID_STRID_REC */ 
	{ "Stop & Go", 9 },			/* LV_PLUGIN_STRING_ID_STRID_SNG */ 
	{ "Driver Fatigue Alarm", 20 },			/* LV_PLUGIN_STRING_ID_STRID_FATIGUE_DRIVING */ 
	{ "Light Reminder ", 15 },			/* LV_PLUGIN_STRING_ID_STRID_REMIND_LIGHT */ 
	{ "30 Mins", 7 },			/* LV_PLUGIN_STRING_ID_STRID_FATIGUE_30MIN */ 
	{ "1 Hour", 6 },			/* LV_PLUGIN_STRING_ID_STRID_FATIGUE_1HOUR */ 
	{ "2 Hour", 6 },			/* LV_PLUGIN_STRING_ID_STRID_FATIGUE_2HOUR */ 
	{ "4 Hour", 6 },			/* LV_PLUGIN_STRING_ID_STRID_FATIGUE_4HOUR */ 
	{ "Speed Unit", 10 },			/* LV_PLUGIN_STRING_ID_STRID_SPEED_UNIT */ 
	...
	{ "Front Camera", 12 },			/* LV_PLUGIN_STRING_ID_STRID_ONE_CAMERA */ 
	{ "Dual Camera", 11 },			/* LV_PLUGIN_STRING_ID_STRID_TWO_CAMERA */ 
	{ "Display Mode", 12 },			/* LV_PLUGIN_STRING_ID_STRID_DISPLAY_MODE */ 
	{ "Front Camera", 12 },			/* LV_PLUGIN_STRING_ID_STRID_FRONT_CAMERA */ 
	{ "Middle Camera", 13 },			/* LV_PLUGIN_STRING_ID_STRID_MIDDLE_CAMERA */ 
	{ "Rear Camera", 11 },			/* LV_PLUGIN_STRING_ID_STRID_BACK_CAMERA */ 
	{ "Dual View", 9 },			/* LV_PLUGIN_STRING_ID_STRID_PICTURE_IN_PICTURE */ 
	{ "q1234567890~!@#$%^&*()-_=+[]{}|\\/:;'\"", 39 },			/* LV_PLUGIN_STRING_ID_STRID_FILL_ASCII */ 
	...
	{ "Boot Delay", 10 },			/* LV_PLUGIN_STRING_ID_STRID_BOOT_DELAY */ 
	{ "15 Seconds", 10 },			/* LV_PLUGIN_STRING_ID_STRID_15SEC */ 
	{ "30 Seconds", 10 },			/* LV_PLUGIN_STRING_ID_STRID_30SEC */ 
	{ "GPS Info Stamp", 14 },			/* LV_PLUGIN_STRING_ID_STRID_GPS_STAMP */ 
	{ "Coordinates", 11 },			/* LV_PLUGIN_STRING_ID_STRID_COORDINATES */ 
	{ "Speed", 5 },			/* LV_PLUGIN_STRING_ID_STRID_SPEED */ 
	{ "Coords+Speed", 12 },			/* LV_PLUGIN_STRING_ID_STRID_COORDINATES_SPEED */ 
	...
	{ "Emergency", 9 },			/* LV_PLUGIN_STRING_ID_STRID_VIDEO_FLIE_RO */ 
	...
	{ "12 Hours", 8 },			/* LV_PLUGIN_STRING_ID_STRID_12HOUR */ 
	{ "24 Hours", 8 },			/* LV_PLUGIN_STRING_ID_STRID_24HOUR */ 
	{ "48 Hours", 8 },			/* LV_PLUGIN_STRING_ID_STRID_48HOUR */ 
	{ "72 Hours", 8 },			/* LV_PLUGIN_STRING_ID_STRID_72HOUR */ 
	...
	{ "Parking Mode", 12 },			/* LV_PLUGIN_STRING_ID_STRID_PARKING_MODE */ 
	...
	{ "60 Minutes", 10 },			/* LV_PLUGIN_STRING_ID_STRID_60MIN */ 
	{ "Screen Save", 11 },			/* LV_PLUGIN_STRING_ID_STRID_SCREEN_SAVE */ 
	{ "Dual Record", 11 },			/* LV_PLUGIN_STRING_ID_STRID_DUAL_REC */ 
	{ "Time-lapse Record", 17 },			/* LV_PLUGIN_STRING_ID_STRID_TIMELAPSE_REC */ 
	{ "Time-lapse Capture", 18 },			/* LV_PLUGIN_STRING_ID_STRID_TIMELAPSE_CAP */ 
	{ "Make Movie by Photo", 19 },			/* LV_PLUGIN_STRING_ID_STRID_MAKE_MOVIE */ 
	{ "Processing…", 13 },			/* LV_PLUGIN_STRING_ID_STRID_PROCESSING */ 
