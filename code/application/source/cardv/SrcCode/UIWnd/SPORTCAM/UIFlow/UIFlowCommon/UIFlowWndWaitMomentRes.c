...
SHOW_ITEM_RECT(CMD_Rectangle,Rect5,0,0,508,151,16,0,14,14,0,0,0)
SHOW_MAP_BEGIN(Skin3)
SHOW_MAP_BODY(Rect5)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin3,0,0,508,151)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text7,0,58,508,139,STRID_NULL,0,0,0,0,2,2,1,0,0,1,0,0,0,0)
SHOW_MAP_BEGIN(Normal2)
SHOW_MAP_BODY(Skin3)
SHOW_MAP_BODY(Text7)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal2,55,53,563,204)
...
CREATE_STATE_CTRL(UIFlowWndWaitMoment_StatusTXT_Msg,0,55,53,563,204)
...
CREATE_CTRL(UIFlowWndWaitMoment,UIFlowWndWaitMoment,CTRL_WND,NULL,0 ,0,0,619,239)
#endif
