...
SHOW_ITEM_GROUP(CMD_Group,Normal4,72,57,287,94)
...
SHOW_ITEM_GROUP(CMD_Group,Focused8,72,57,287,94)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text22,1,5,216,35,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Normal_Disable19)
SHOW_MAP_BODY(Skin20)
SHOW_MAP_BODY(Text22)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal_Disable19,72,57,287,94)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text26,1,5,216,35,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Focused_Disable23)
SHOW_MAP_BODY(Skin24)
SHOW_MAP_BODY(Text26)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Focused_Disable23,72,57,287,94)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text30,1,5,216,35,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Pressed27)
SHOW_MAP_BODY(Skin28)
SHOW_MAP_BODY(Text30)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Pressed27,72,57,287,94)
...
CREATE_LIST_CTRL(UIMenuWndSetupFormat_List_Text,UIMenuWndSetupFormat_List_Text,0,72,57,287,94)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
