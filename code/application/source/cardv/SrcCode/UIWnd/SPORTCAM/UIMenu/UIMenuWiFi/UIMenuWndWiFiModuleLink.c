...
#define UIMenuWndWiFiModuleLinkErrMsg(...)            DBG_MSG ("^R UIMenuWndWiFiModuleLink: "__VA_ARGS__)
#else
#define UIMenuWndWiFiModuleLinkErrMsg(...)
#endif

#if (_UIMENUWNDWIFIMODULELINK_TRACE_MSG&(PRJ_DBG_LVL>=PRJ_DBG_LVL_TRC))
#define UIMenuWndWiFiModuleLinkTraceMsg(...)          DBG_MSG ("^B UIMenuWndWiFiModuleLink: "__VA_ARGS__)
#else
