...
#endif
#else // only 1 sensor
#if (defined(_MODEL_580_SDV_I860_) || defined(_MODEL_580_SDV_SJ10_FAST_BT_) || defined(_MODEL_580_SDV_C300_) \
	|| defined(_MODEL_580_SDV_C300_FAST_BT_) || defined(_MODEL_580_SDV_I860_))
    TMDEF_OPTION_TEXT_S(MOVIE_SIZE_FRONT_2880x2160P50,              TM_OPTION_NOT_SUPPORT)  /// UHD P50 (DAR)
