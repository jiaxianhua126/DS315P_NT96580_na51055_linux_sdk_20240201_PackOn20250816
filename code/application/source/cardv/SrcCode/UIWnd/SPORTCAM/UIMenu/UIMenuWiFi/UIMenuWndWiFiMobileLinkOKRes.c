...
SHOW_ITEM_RECT(CMD_Rectangle,Skin3Rect,0,0,201,25,0,0,14,14,0,0,0)
SHOW_MAP_BEGIN(Skin3)
SHOW_MAP_BODY(Skin3Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin3,0,0,201,25)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text5,0,0,201,25,STRID_NULL,0,0,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal2)
SHOW_MAP_BODY(Skin3)
SHOW_MAP_BODY(Text5)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal2,84,74,285,99)
...
CREATE_STATIC_CTRL(UIMenuWndWiFiMobileLinkOK_StaticTXT_LinkSts,0,84,74,285,99)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin8Rect,0,0,271,27,0,0,14,14,0,0,0)
SHOW_MAP_BEGIN(Skin8)
SHOW_MAP_BODY(Skin8Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin8,0,0,271,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text10,2,0,271,27,STRID_NULL,0,0,0,0,7,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal7)
SHOW_MAP_BODY(Skin8)
SHOW_MAP_BODY(Text10)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal7,36,192,307,219)

SHOW_MAP_BEGIN(Skin12)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin12,0,0,271,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text14,2,0,271,27,STRID_NULL,0,0,0,0,1,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Focused11)
SHOW_MAP_BODY(Skin12)
SHOW_MAP_BODY(Text14)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Focused11,36,192,307,219)

SHOW_MAP_BEGIN(Skin16)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin16,0,0,271,27)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable15,36,192,307,219)

SHOW_MAP_BEGIN(Skin20)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin20,0,0,271,27)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable19,36,192,307,219)

SHOW_MAP_BEGIN(Skin24)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin24,0,0,271,27)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed23,36,192,307,219)

CREATE_BUTTON_ITEM_DATA(STRID_NULL_27,STRID_NULL_,ICON_OK,STATUS_ENABLE,NULL) 
...
CREATE_BUTTON_CTRL(UIMenuWndWiFiMobileLinkOK_Button_Disconnect,UIMenuWndWiFiMobileLinkOK_Button_Disconnect,0,36,192,307,219)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin29Rect,0,0,249,25,0,0,14,14,0,0,0)
SHOW_MAP_BEGIN(Skin29)
SHOW_MAP_BODY(Skin29Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin29,0,0,249,25)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text31,0,0,249,25,STRID_NULL,0,0,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal28)
SHOW_MAP_BODY(Skin29)
SHOW_MAP_BODY(Text31)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal28,50,110,299,135)
...
CREATE_STATIC_CTRL(UIMenuWndWiFiMobileLinkOK_StaticTXT_MAC,0,50,110,299,135)
