...
static MOVIE_SIZE_ITEM g_MovieSizeTable[] = {
	...
	[MOVIE_SIZE_3840x2160P25] = {
		{3840, 2160, 25, 3000 * 1024, MEDIAREC_DAR_DEFAULT, IMAGERATIO_16_9},
		{1, 3, 36, 8, -8, 0},
		{1, 4, 25, 3000 * 1024, 25, 26, 10, 50, 26, 10, 50, -20, 1, 8, 4},
	},
	...
	[MOVIE_SIZE_1920x1080P30] = {
		...
		{1, 3, 36, 8, -8, 0},
		{1, 4, 30, 1200 * 1024, 15, 26, 10, 40, 26, 10, 40, -20, 1, 8, 4},
	},

	[MOVIE_SIZE_1920x1080P25] = {
		{1920, 1080, 25, 1200 * 1024, MEDIAREC_DAR_DEFAULT, IMAGERATIO_16_9},
		{1, 3, 36, 8, -8, 0},
		{1, 4, 25, 1200 * 1024, 15, 26, 10, 40, 26, 10, 40, -20, 1, 8, 4},
	},
...
static MOVIE_SIZE_ITEM g_MovieSizeTable[] = {
	...
	[MOVIE_SIZE_3840x2160P25] = {
		...
		{1, 3, 36, 8, -8, 0},
		{1, 4, 25, 3500 * 1024, 25, 26, 10, 40, 26, 10, 40, 0, 1, 8, 4},
	},
	...
	[MOVIE_SIZE_1920x1080P30] = {
		...
		{1, 3, 36, 8, -8, 0},
		{1, 4, 28, 1200 * 1024, 15, 26, 10, 40, 26, 10, 40, -20, 1, 8, 4},
	},

	[MOVIE_SIZE_1920x1080P25] = {
		{1920, 1080, 25, 1200 * 1024, MEDIAREC_DAR_DEFAULT, IMAGERATIO_16_9},
		{1, 3, 36, 8, -8, 0},
		{1, 4, 25, 1200 * 1024, 25, 26, 10, 40, 26, 10, 40, -20, 1, 8, 4},
	},
