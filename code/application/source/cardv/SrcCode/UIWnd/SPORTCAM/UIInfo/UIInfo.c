...
void SysCheckFlag(void)
{
    ...
    SysLimitFlag(FL_MOVIE_LDWS,         0,  ADAS_LDWS_ID_MAX,          DEFAULT_MOVIE_LDWS);
    SysLimitFlag(FL_MOVIE_LDWS_MENU,    0,  ADAS_LDWS_ID_MAX,          DEFAULT_MOVIE_LDWS);
    SysLimitFlag(FL_MOVIE_FCW,          0,  ADAS_FCW_ID_MAX,           DEFAULT_MOVIE_FCWS);
    SysLimitFlag(FL_MOVIE_FCW_MENU,     0,  ADAS_FCW_ID_MAX,           DEFAULT_MOVIE_FCWS);
	SysLimitFlag(FL_ADAS_LCAWS,         0,  ADAS_LCAWS_ID_MAX,          DEFAULT_ADAS_LCAWS);
    SysLimitFlag(FL_SNG,    			0,  ADAS_SNG_ID_MAX,        	DEFAULT_SNG);
	SysLimitFlag(FL_PCW,    			0,  ADAS_PCW_ID_MAX,        	DEFAULT_PCW);
	SysLimitFlag(FL_RCW,    			0,  ADAS_RCW_ID_MAX,        	DEFAULT_RCW);
    SysLimitFlag(FL_ADAS_VIRTUAL_BUMPER,0,  ADAS_VIRTUAL_BUMPER_ID_MAX, DEFAULT_ADAS_VIRTUAL_BUMPER);
	SysLimitFlag(FL_ADAS_PANEL,     	0,  ADAS_PANEL_ID_MAX,          DEFAULT_ADAS_PANEL);
    ...
    SysLimitFlag(FL_MOVIE_ADAS_CORDON,  0,  MOVIE_CORDON_LOW,           DEFAULT_ADAS_CORDON);
...
void SysResetFlag(void)
{
	...
	SysSetFlag(FL_MOVIE_FCW,       DEFAULT_MOVIE_FCWS);
	SysSetFlag(FL_ADAS_LCAWS,      DEFAULT_ADAS_LCAWS);
	SysSetFlag(FL_SNG,    		   DEFAULT_SNG);
	SysSetFlag(FL_PCW,    		   DEFAULT_PCW);
	SysSetFlag(FL_RCW,    		   DEFAULT_RCW);
	SysSetFlag(FL_ADAS_VIRTUAL_BUMPER,      DEFAULT_ADAS_VIRTUAL_BUMPER);	
	SysSetFlag(FL_ADAS_PANEL,      DEFAULT_ADAS_PANEL);
	//#NT#2016/07/12#KCHong#[0104994] -end
	...
	SysSetFlag(FL_MOVIE_ADAS_CORDON,	DEFAULT_ADAS_CORDON);
	// Playback
	SysSetFlag(FL_PROTECT,              DEFAULT_PROTECT);
