...
void SysCheckFlag(void)
{
    ...
    SysLimitFlag(FL_ADAS_STOP_GO,    	0,  ADAS_STOP_GO_ID_MAX,        DEFAULT_ADAS_STOP_GO);
    SysLimitFlag(FL_ADAS_PCWS,          0,  ADAS_PCWS_ID_MAX,           DEFAULT_ADAS_PCWS);
    SysLimitFlag(FL_ADAS_RCWS,     		0,  ADAS_RCWS_ID_MAX,           DEFAULT_ADAS_RCWS);	
...
void SysResetFlag(void)
{
	...
	SysSetFlag(FL_ADAS_STOP_GO,    DEFAULT_ADAS_STOP_GO);
	SysSetFlag(FL_ADAS_PCWS,       DEFAULT_ADAS_PCWS);
	SysSetFlag(FL_ADAS_RCWS,       DEFAULT_ADAS_RCWS);
