...
//..............................................................................
// FW version and name
#define FW_UPDATE_NAME                  "A:\\FW98528Z.bin"
#define FW_VERSION_RELEASE              DISABLE //DISABLE
#define FW_VERSION_NUM                  "1.0.3.20210810"//"REGULAR_0402_001"
...
#define SENSOR_CAPS_COUNT                 3
#define SENSOR_CAPS_MASK                 (SENSOR_1 | SENSOR_2 | SENSOR_3)
#elif (!defined(_SENSOR1_sen_off_) && !defined(_SENSOR2_sen_off_) && defined(_SENSOR3_sen_off_))
...
#define SENSOR_MAP_3                    SENSOR_ID_3
...
#define SENSOR_GP_3                     SENSOR_MULTI_ID_NONE /*ex: SENSOR_MULTI_ID_3|SENSOR_MULTI_ID_4*/
// Sensor sub group
...
#if (!defined(_SENSOR1_sen_off_) && !defined(_SENSOR2_sen_off_) && !defined(_SENSOR3_sen_off_))
#define SENSOR_INSERT_MASK             SENSOR_2 // if NOT support insert sensor, please choose this
#elif (!defined(_SENSOR1_sen_off_) && !defined(_SENSOR2_sen_off_) && defined(_SENSOR3_sen_off_))
#define SENSOR_INSERT_MASK             SENSOR_2 // if NOT support insert sensor, please choose this
#else
...
#if (!defined(_SENSOR1_sen_off_) && !defined(_SENSOR2_sen_off_) && !defined(_SENSOR3_sen_off_))
#define SENSOR_DEFAULT_DISPLAY_MASK     (SENSOR_1 | SENSOR_3)
#elif (!defined(_SENSOR1_sen_off_) && !defined(_SENSOR2_sen_off_) && defined(_SENSOR3_sen_off_))
...
// OSD size and format
#if defined(_disp_ifdsi_lcd1_LX118FHDB4098_OTA7290B_)
#define DISPLAY_OSD_W                   1920//320//640
#define DISPLAY_OSD_H                   448
#elif defined(_disp_ifdsi_lcd1_tb118_)
#define DISPLAY_OSD_W                   1488//320//640
#define DISPLAY_OSD_H                   320//240
#else
#define DISPLAY_OSD_W                   1480//640
#define DISPLAY_OSD_H                   320
#endif
...
#if defined(_disp_ifdsi_lcd1_LX118FHDB4098_OTA7290B_)
#define TOOL_LAYOUT_W                   1920//320//640
#define TOOL_LAYOUT_H                   448//240
#elif defined(_disp_ifdsi_lcd1_tb118_)
#define TOOL_LAYOUT_W                   1488//320//640
#define TOOL_LAYOUT_H                   320//240//480
#else
#define TOOL_LAYOUT_W                   1480//640
#define TOOL_LAYOUT_H                   320//480
#endif
#define OSD_USE_DOUBLE_BUFFER           ENABLE //use double buffer
#if (defined(_Disp_IF8B_LCD1_ILI9341_)||defined(_disp_ifdsi_lcd1_wtl096602g02_24m_) \
||defined(_disp_ifdsi_lcd1_tb118_)||defined(_disp_ifdsi_lcd1_wtl098802g01_ota7290b_) \
||defined(_disp_ifdsi_lcd1_st7701s_t30p115_) ||defined(_disp_ifdsi_lcd1_LX118FHDB4098_OTA7290B_) \
)
...
// VDO size and format
#if defined(_disp_ifdsi_lcd1_LX118FHDB4098_OTA7290B_)
#define DISPLAY_VDO_W                   1920//320//640
#define DISPLAY_VDO_H                 448//240
#elif defined(_disp_ifdsi_lcd1_tb118_)
#define DISPLAY_VDO_W                  1488// 1920//640//1488//640
#define DISPLAY_VDO_H                  320// 448// 480// 320
#else
...
#if (defined(_Disp_IF8B_LCD1_ILI9341_)||defined(_disp_ifdsi_lcd1_wtl096602g02_24m_) \
||defined(_disp_ifdsi_lcd1_tb118_)||defined(_disp_ifdsi_lcd1_wtl098802g01_ota7290b_) \
||defined(_disp_ifdsi_lcd1_st7701s_t30p115_) \
)
...
#elif defined(_disp_ifdsi_lcd1_LX118FHDB4098_OTA7290B_)
#define VDO_ROTATE_DIR                  HD_VIDEO_DIR_ROTATE_270
#define VDO_USE_ROTATE_BUFFER           ENABLE  //use rotate buffer (enable to support LCD with stripe-type subpixel)
#define LOGO_USE_ROTATE_BUFFER          ENABLE
#else
...
#define MOVIE_DIRECT_FUNC               DISABLE//DISABLE  // direct mode function
...
#define CROP_SOURCE_W                   3840//1920
...
#define NVT_ETHREARCAM_RX				DISABLE
#define ETH_REARCAM_CAPS_COUNT			0
#define ETH_REARCAM_CLONE_FOR_DISPLAY	DISABLE

#define ACC_PLUGIN_DET_FUNC        ENABLE

#define USER_TIMER_FUNC			ENABLE
#define RESERVE_DET_FUNC	    ENABLE
#define GPS_UPDATE_TIME_FUNC    ENABLE
...
#ifdef LV_PLUGIN_FONT_ID_NOTOSANS_BLACK_16_1BPP
#define LV_USER_CFG_STAMP_FONT_ID_SMALL			LV_PLUGIN_FONT_ID_NOTOSANS_BLACK_16_1BPP
#else
#define LV_USER_CFG_STAMP_FONT_ID_SMALL			LV_PLUGIN_FONT_ID_NOTOSANS_BLACK_32_1BPP
#endif
